...
class AutocompletejsBundle {
    ...
    static init() {
        setTimeout(() => AutocompletejsBundle.initAutocompleteJs(), 100);
    }

    static initAutocompleteJs() {
        ...
        autocompleteFields.forEach((field) => {
            AutocompletejsBundle.initField(field);
        });
    }

    static elementCallback(item, data) {
    ...
    static initField(field) {
        if (field.autoCompleteInitialied === true) {
            return;
        }
        field.autoCompleteInitialied = true;
        ...
        ctx.resultItem = {
            ...
            element: AutocompletejsBundle.elementCallback,
